                ...
                <Row xs="1">
                    <Col md='4' className="resume-left-col">
                        ...
                        <div className="text-left">
                            ...
                            <p>На странице проектов вы можете увидеть некоторые работы, над которыми я работал в последнее время. Я классифицировал проекты по основным технологиям.</p>
                            <hr style={{borderTop: '3px solid #833fb2', width: '50%'}} />
                    ...
                    <Col md='8' className="resume-right-col">
                        ...
                        <Row xs="1">
                            ...
                            <Col>
                                <Row xs="1" className="education">
                                    <Col xs="8" sm="4"><p>2013 - Настоящее время</p></Col>
                                    <Col sm="8" style={{textAlign: 'left'}}>
